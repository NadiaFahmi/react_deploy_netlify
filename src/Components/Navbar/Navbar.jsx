...
import Mody from '../../assets/Mody.png'
  ...
  return (
    <div className='navbar'>
      ...
      <ul ref={menuRef}className="nav-menu">
        ...
        <li><AnchorLink  className='anchor-link' offset={50} href='#about'><p onClick={()=>setMenu("about")}>About Me</p></AnchorLink>
        ...
        <li><AnchorLink  className='anchor-link' offset={50} href='#work'> <p onClick={()=>setMenu("work")}>Portfolio</p></AnchorLink>
         {menu==="work" ?<img src={underline} alt='' />:<></>}</li>
